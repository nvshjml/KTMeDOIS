    ...
    <div class="row g-4 align-items-start">
        <div class="col-xxl-8 col-xl-9">
            <section class="content-card p-4">
                ...
                <p class="text-muted small mb-4">Upload the Delivery Order file and proof of delivery. The system will auto-generate the Delivery Order details.</p>

                <div class="row g-3">
                    <div class="col-12">
                        <div class="upload-panel h-100">
                            <div class="fw-bold mb-3">Upload File (DO &amp; Proof of Delivery)</div>
                            <div class="row g-3">
                                <div class="col-md-6">
